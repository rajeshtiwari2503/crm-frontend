...
const PartPendingTodayNotUpadteComplaintList = (props) => {
    ...
    const getAllComplaint = async () => {
        try {
            let response = await http_request.get("/check-part-pending")
            let { data } = response;

            setComplaint(data?.notUpdatedToday  )
        }
        catch (err) {
            console.log(err);
        }
...
//   "date-fns": "^4.1.0",   "react-day-picker": "8.10.1",
    ...
    return (
        <div>
            ...
            <div className='flex justify-between items-center mb-3'>
                <div className='font-bold text-xl'> Part Pending Today Not Update Complaints</div>
...
export default PartPendingTodayNotUpadteComplaintList;
