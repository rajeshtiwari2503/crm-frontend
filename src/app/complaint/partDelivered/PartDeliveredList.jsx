 ...
 const PartDeliveredComplaintList = (props) => {
   ...
   return (
     <div>
       ...
       <div className='flex justify-between items-center mb-3'>
         <div className='font-bold text-2xl'>Part Delivered Service Information</div>
                     ...
                     <TableRow key={row?.i} hover>
                       ...
                       <TableCell className="p-0">
                         <div className="flex items-center space-x-2">
                           ...
                           // userData?.role === "ADMIN" || userData?.role === "EMPLOYEE"  ||userData?.role === "BRAND" ?
                           //   <div
       ...
       <Dialog open={status} onClose={handleUpdateClose}>
         ...
         <DialogContent>
           ...
           <form onSubmit={handleSubmit(onSubmit)}>
             ...
             <div>
               <button type="submit"
                 disabled={userData?.role === "SERVICE" && compStatus === "FINAL VERIFICATION" && !otpVerified} className="rounded-lg p-3 w-full mt-5 border border-gray-500 bg-[#09090b] text-white hover:bg-white hover:text-black hover:border-black transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed">
                 Submit
               </button>
             </div>
           </form>
 ...
 export default PartDeliveredComplaintList;
