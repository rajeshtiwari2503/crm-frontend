...
function SparePartAdd() {
    ...
    const addSparePart = async () => {
        try {
            ...
            formData.append("length", sparePart?.length ? Number(sparePart.length) : 0);
            formData.append("weight", sparePart?.weight ? Number(sparePart.weight) : 0);
            formData.append("height", sparePart?.height ? Number(sparePart.height) : 0);
            formData.append("breadth", sparePart?.breadth ? Number(sparePart.breadth) : 0);
