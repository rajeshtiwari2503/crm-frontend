...
const PartPendingTodayUpadteComplaintList = (props) => {
    ...
    const getAllComplaint = async () => {
        try {
            ...
            setComplaint(data?.updatedToday  )
        }
        catch (err) {
            console.log(err);
        }
    ...
    return (
        <div>
            ...
            <div className='flex justify-between items-center mb-3'>
                <div className='font-bold text-xl'> Part Pending Today   Update Complaint</div>
...
export default PartPendingTodayUpadteComplaintList;
