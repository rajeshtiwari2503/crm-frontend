...
const ServiceCenterRepot = (props) => {
    ...
    const fetchComplaints = async () => {
        try {
            ...
            const dealerComplaints = props?.userData?.role==="SERVICE"?response?.data?.filter((item) => item?.assignServiceCenterId === props?.userData?._id)
           : response?.data?.filter((item) => item?.assignServiceCenterId === props?.userData?._id)
...
export default ServiceCenterRepot;
