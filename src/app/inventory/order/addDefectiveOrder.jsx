...
export default function SparePartsDefcetiveForm({ sparepart,userData ,RefreshData,onClose,brands,centers}) {
...
// console.log("filteredSpareParts",filteredSpareParts);
  ...
  return (
    ...
    <div className="max-w-2xl mx-auto p-2 bg-white shadow-lg rounded-lg">
      <Toaster />
    <h2 className="text-xl font-semibold mb-4">Defective Spare Parts  Form</h2>
