...
const BrandReport = (props) => {
    ...
    useEffect(() => {
        fetchComplaints(); // Load complaints on initial render
    }, [ ]);
    ...
    const fetchComplaints = async () => {
        try {
            ...
            const requestData = {
                ...
                startDate: startDate ? startDate.toISOString() : today.toISOString(),
                endDate: endDate ? endDate.toISOString() : today.toISOString(),
                selectedStatuses
            };
